...
void drawRectangle(int x, int y, int a);
...
void draw()
{
    ...
    for (int i = 0; i < 20; ++i) {
        drawRectangle(0 + i * 20, 0 + i * 20, 20);
    }
...
void drawRectangle(int x, int y, int a)
{
    SDL_SetRenderDrawColor(gRenderer, 212, 0, 255, 0xFF);
    SDL_Rect fillRect = { x, y, a, a};
    SDL_RenderFillRect( gRenderer, &fillRect );
    SDL_SetRenderDrawColor(gRenderer, 40, 0, 48, 0xFF);
